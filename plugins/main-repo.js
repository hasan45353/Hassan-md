...
async (conn, mek, m, { from, reply }) => {
    const githubRepoURL = 'https://github.com/hasan45353/Hassan-md';
...
> ${config.DESCRIPTION}`;
        ...
        await conn.sendMessage(from, {
            image: { url: config.MENU_IMAGE_URL || 'https://i.ibb.co/LztYC5fq/7759.jpg' },
            ...
            contextInfo: { 
                ...
                forwardedNewsletterMessageInfo: {
                    ...
                    newsletterName: config.OWNER_NAME || 'HassanRajpoot',
                    serverMessageId: 143
                }
            }
        }, { quoted: mek });
