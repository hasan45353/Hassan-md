    ...
    if (m.mentionedJid.includes(botNumber)) {
      ...
      await conn.sendMessage(m.chat, {
        ...
        contextInfo: {
          ...
          isForwarded: true,
          externalAdReply: {
            title: config.BOT_NAME || "HASSAN-MD 🥀",
            body: config.DESCRIPTION || "POWERED BY HASSAN RAJPOOT 🤌💗",
            mediaType: 1,
            renderLargerThumbnail: true,
            thumbnail: thumbnailBuffer,
            mediaUrl: "https://i.ibb.co/prspZ5Fx/2900.jpg", // Static image URL
            sourceUrl: "https://wa.link/rph7ps",
